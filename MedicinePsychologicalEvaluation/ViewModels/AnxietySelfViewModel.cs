...
{
    public class AnxietySelfViewModel : ViewModelBase, IRoutableViewModel
    {

        public IScreen HostScreen { get; }

        public string UrlPathSegment { get; } = "/anxietyself";
        ...
        public AnxietySelfViewModel(IScreen screen)
        {
        ...
        private List<Medicine_Evaluation> CreateItems()
        {
            ...
            {
                var evaluations = db.Medicine_Evaluation.Where(t => t.EvaluationType == EvaluationType.焦虑自评).AsNoTracking();
