...
{
    public class AnxietyOtherViewModel : ViewModelBase, IRoutableViewModel
    {
        public IScreen HostScreen { get; }

        public string UrlPathSegment { get; } = "/anxietyother";
        ...
        public AnxietyOtherViewModel(IScreen screen)
        {
        ...
        private List<Medicine_Evaluation> CreateItems()
        {
            ...
            {
                var evaluations = db.Medicine_Evaluation.Where(t => t.EvaluationType == EvaluationType.焦虑他评).AsNoTracking();
